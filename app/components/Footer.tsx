            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  className="w-10 h-10 rounded-full glass border border-[#ff7d00]/30 flex items-center justify-center hover:border-[#ff7d00] hover:bg-[#ff7d00]/10 transition-all text-[#ffecd1] hover:text-[#ff7d00]"
