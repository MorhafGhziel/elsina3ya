...
const socialLinks = [
  {
    ...
    href: "https://www.linkedin.com/company/alsnaya%D9%80sa/",
  },
  {
    name: "Instagram",
    icon: (
    ...
    href: "https://www.instagram.com/alsnaya_sa",
  },
  {
    name: "Twitter",
    icon: (
    ...
    href: "https://x.com/alsnaya_sa?s=21",
  },
];
    ...
    <footer className="relative overflow-hidden bg-[#111111] grain-overlay">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-16">
        ...
        >
          ...
          {/* Quick Links Section */}
          <div className="text-right">
            <h3 className="text-[#FFF6F3] font-bold text-lg mb-6">
              روابط سريعة
            </h3>
            <ul className="space-y-3">
              <li>
                <Link
                  href="#story"
                  className="text-[#FFF6F3]/50 hover:text-[#FF4800] transition-colors text-sm"
                >
                  قصتنا
                </Link>
              </li>
          ...
          <div className="text-right">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <div className="w-10 h-10 bg-[#FF4800]/10 border border-[#FF4800]/30 rounded flex items-center justify-center shrink-0">
                  <svg
                ...
                <span className="text-[#FFF6F3]/50 text-sm">
